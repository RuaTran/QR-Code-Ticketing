/*
const logo = document.querySelectorAll('#matsuri path');
...
if (params != null && !(params === "")){ 
	...
	//document.getElementById("content").innerHTML = "Please scan a valid ticket";
	var xmlhttp = new XMLHttpRequest();
    xmlhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
		if (this.responseText.includes('invalid request!')){
			document.getElementById("welcomeMessage").innerHTML = "Please scan a valid ticket";
		} else {
			...
			document.getElementById("welcomeMessage").innerHTML = response [1] + " Welcome " + response [1] + "<br> " + response[0];
			
		}
      }
    };
    xmlhttp.open("GET","http://box5427.temp.domains/~ucscjsac//test.php?q="+params,true);
    params = xmlhttp.send();
	//console.log(params);
	//$('#content').text(params);
}
...
(function ($) {
                ...
                $.fn.sakura = function (event, options) {
                    ...
                    var defaults = {
                        blowAnimations: ['blow-soft-left', 'blow-medium-left', 'blow-hard-left'],
                        className: 'sakura',
                        fallSpeed: 1.3,
                        maxSize: 16,
                        minSize: 12,
                    ...
                    if (typeof event === 'undefined' || event === 'start') {
                        ...
                        var petalCreator = function () {
                            ...
                            .css({
                                ...
                                height: height + 'px',
                                left: (Math.random() * document.documentElement.clientWidth-10) + 'px',
...
/*$
.ajax({
  url: 'http://box5427.temp.domains/~ucscjsac//test.php',
